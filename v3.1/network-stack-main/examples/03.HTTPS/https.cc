...
DECLARE_AND_DEFINE_CONNECTION_CAPABILITY(ExampleComTLS, "example.com", 443,
                                         ConnectionTypeTCP);
...
void __cheri_compartment("https_example") example() {
  ...
  auto tlsSocket =
      tls_connection_create(&unlimited, TEST_MALLOC,
                            CONNECTION_CAPABILITY(ExampleComTLS), TAs, TAs_NUM);
