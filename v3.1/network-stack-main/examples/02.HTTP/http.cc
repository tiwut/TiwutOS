...
DECLARE_AND_DEFINE_CONNECTION_CAPABILITY(ExampleCom, "www.example.com", 80,
                                         ConnectionTypeTCP);
...
void __cheri_compartment("http_example") example() {
  ...
  auto socket = network_socket_connect_tcp(&unlimited, TEST_MALLOC,
                                           CONNECTION_CAPABILITY(ExampleCom));
